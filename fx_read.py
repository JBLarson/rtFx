...
def test_animate(i):
	...
	ax1.set_title('Long Position', fontsize=14)
	ax1.set_ylabel('Result($)', fontsize=14)
	ax1.set_xticks([])
	ax2.clear()
	ax2.stackplot(pts,s1)
	ax2.set_title('Short Position', fontsize=14)
	ax2.set_xticks([])
	ax3.clear()
	ax3.stackplot(pts,net)
	ax3.set_title('Net Position', fontsize=14)
	ax3.set_xlabel('Strike Price', fontsize=14)
	...
	ax4.set_xlabel('Strike Price', fontsize=14)
